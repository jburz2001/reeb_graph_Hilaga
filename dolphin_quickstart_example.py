...
it two 2D scalar fields as numpy arrays and get back a similarity score.
Each field is treated as a height map on a flat triangulated grid (no
CAD model files or VTK required); internally it's converted to a mesh,
